    ...
    server.registerTool(
        "get_current_weather",
        {
            ...
            inputSchema: {
                ...
                latitude: z.number().describe("___BLANK_1___"), // ใส่คำอธิบาย parameter เช่น "ละติจูด เช่น 13.75"
                // longitude คือ ลองจิจูด เช่น 100.5
                longitude: z.number().describe("___BLANK_2___"), // ใส่คำอธิบาย parameter เช่น "ลองจิจูด เช่น 100.5"
            },
        },
        async ({ latitude, longitude }) => {
            ...
            const url = `https://api.open-meteo.com/v1/forecast?latitude=${"___BLANK_3___"}&longitude=${"___BLANK_4___"}&current_weather=true`;
